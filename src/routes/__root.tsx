...
const orgJsonLd = JSON.stringify({
  ...
  url: "https://fueltracks.in",
  logo: "/icons/fuel-tracks-logo.png",
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/icons/fuel-tracks-logo.png" },
      { name: "twitter:image", content: "/icons/fuel-tracks-logo.png" },
