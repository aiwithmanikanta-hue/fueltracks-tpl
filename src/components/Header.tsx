        ...
        {open && (
          <div className="lg:hidden mt-2 glass-strong rounded-2xl p-3 flex flex-col gap-1 shadow-elegant animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              ...
              <a href="http://admin.fueltracks.in/login" className="text-center px-4 py-3 text-xs font-bold tracking-wider rounded-xl bg-primary text-primary-foreground">ADMIN LOGIN</a>
            </div>
          </div>
        )}
      </div>
